...
public class Treasurer extends Member {
    ...
    public void ViewLoanAndContributionTotals(JTextArea jt) throws SQLException {
        ...
        jt.append("Total Amount Loaned : " + _loan.GetLoanTotal(2) + " (This includes all loans regardless of whether they hav been paid or not) \n");
        jt.append("Amount total of loans paid : " + _loan.getPaymentsTotal() + "\n");
        jt.append("\n\n");
        jt.append("Total Interest Acquired From loans : " + Application.df.format(_loan.getInterestTotal()));
